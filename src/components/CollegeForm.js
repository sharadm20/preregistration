...
import { fetchStates, fetchColleges, getToken, fetchVenues, getVenueType, formData } from '../actions/fetchActions';
...
//     this.props.getVenueType(e.target.value);
// }
...
handleValidation=()=>{
 ...
 render(){
  ...
  if (this.props.isLoading) {
   ...
   const collegeItems = this.props.colleges.map(college => (
                 <option key={college.clg_code}> {college.college_name} </option>
             ));
  ...
  const venueItems=this.props.venues && this.props.venues.map(venue => (
   ...
   return (
     <div className="message is-dark has-text-left" >
    ...
    <div className="field columns">
      ...
      <div className="control is-expanded column">
        <div className="select is-fullwidth">
          <select name="loi" onChange={CollegeForm.onChange}>
...
export default connect(mapStateToProps,{fetchStates,fetchColleges, getToken, fetchVenues, getVenueType, formData})(CollegeForm);
